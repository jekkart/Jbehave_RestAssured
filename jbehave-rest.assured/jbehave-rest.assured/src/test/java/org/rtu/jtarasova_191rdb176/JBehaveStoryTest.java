...
import org.rtu.jtarasova_191rdb176.steps.CreateUserSteps;
...
public class JBehaveStoryTest extends JUnitStories {

    public JBehaveStoryTest() {
    ...
    public InjectableStepsFactory stepsFactory() {
        return new InstanceStepsFactory(configuration(), new CreateUserSteps());
    }
